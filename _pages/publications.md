...
<div style="max-width: 900px; margin: auto; padding: 2rem; font-family: system-ui, sans-serif; line-height: 1.6;">
  ...
  <div style="margin-bottom: 2.8rem;">
    <div style="display: flex; justify-content: space-between; align-items: baseline; flex-wrap: wrap;">
      ...
      <a href="/images/Certificate of Service.pdf" target="_blank" style="font-size: 0.95rem;">Certificate</a>
    </div>
  ...
  <div style="margin-bottom: 2.8rem;">
    <div style="display: flex; justify-content: space-between; align-items: baseline; flex-wrap: wrap;">
      ...
      <a href="/images/UBS_Semester_Intern_Certificate.pdf" target="_blank" style="font-size: 0.95rem;">Certificate</a>
    </div>
  ...
  <div style="margin-bottom: 2.8rem;">
    <div style="display: flex; justify-content: space-between; align-items: baseline; flex-wrap: wrap;">
      ...
      <a href="/images/UBS_Summer_Intern_Certificate.pdf" target="_blank" style="font-size: 0.95rem;">Certificate</a>
    </div>
  ...
  <div>
    <div style="display: flex; justify-content: space-between; align-items: baseline; flex-wrap: wrap;">
      ...
      <a href="/images/LOR.pdf" target="_blank" style="font-size: 0.95rem;">LOR</a>
    </div>
