...
top:u.win.top-c.win.top-d.numeric.borderTopWidth,left:u.win.left-c.win.left-d.numeric.borderLeftWidth,right:-u.win.right+c.win.right-d.numeric.borderRightWidth},css:l,isCell:"table-cell"==t.display,computed:a,numeric:s,width:u.win.right-u.win.left,height:u.win.bottom-u.win.top,mode:-1,inited:!1,parent:d,limit:{start:u.doc.top-s.top,end:c.doc.top+n.offsetHeight-d.numeric.borderBottomWidth-e.offsetHeight-s.top-s.marginBottom}}}function b(e){for(var t=0;e;)t+=e.offsetTop,e=e.offsetParent;return t}function x(e){var n=e.getBoundingClientRect();return{doc:{top:n.top+t.pageYOffset,left:n.left+t.pageXOffset},win:n}}function w(){D=setInterval(function(){!c()&&E()},500)}function C(){clearInterval(D)}function T(){H&&(document[P]?C():w())}function k(){H||(o(),p(),t.addEventListener("scroll",a),t.addEventListener("wheel",s),t.addEventListener("resize",E),t.addEventListener("orientationchange",E),e.addEventListener(B,T),w(),H=!0)}function E(){if(H){h();for(var e=I.length-1;e>=0;e--)I[e]=y(I[e].node);p()}}function S(){t.removeEventListener("scroll",a),t.removeEventListener("wheel",s),t.removeEventListener("resize",E),t.removeEventListener("orientationchange",E),e.removeEventListener(B,T),C(),H=!1}function N(){S(),h()}function L(){for(N();I.length;)I.pop()}function A(e){for(var t=I.length-1;t>=0;t--)if(I[t].node===e)return;var n=y(e);I.push(n),H?d(n):k()}function j(e){for(var t=I.length-1;t>=0;t--)I[t].node===e&&(f(I[t]),I.splice(t,1))}var _,D,I=[],H=!1,O=e.documentElement,M=function(){},P="hidden",B="visibilitychange";void 0!==e.webkitHidden&&(P="webkitHidden",B="webkitvisibilitychange"),t.getComputedStyle||n();for(var F=["","-webkit-","-moz-","-ms-"],$=document.createElement("div"),q=F.length-1;q>=0;q--){try{$.style.position=F[q]+"sticky"}catch(e){}""!=$.style.position&&n()}o(),t.Stickyfill={stickies:I,add:A,remove:j,init:k,rebuild:E,pause:S,stop:N,kill:L}}(document,window),window.jQuery&&function(e){e.fn.Stickyfill=function(e){return this.each(function(){Stickyfill.add(this)}),this}}(window.jQuery),$(document).ready(function(){function e(){o.removeAttr("hidden").attr("aria-hidden","false"),$(".masthead__link--resume-access").attr("aria-expanded","true"),$("body").addClass("resume-modal-open"),o.find(".resume-access-modal__close").first().trigger("focus")}function t(){o.attr("hidden","").attr("aria-hidden","true"),$(".masthead__link--resume-access").attr("aria-expanded","false"),$("body").removeClass("resume-modal-open"),a&&$(a).trigger("focus")}var n=function(){$("body").css("margin-bottom",$(".page__footer").outerHeight(!0))},i=!1;n(),$(window).resize(function(){i=!0}),setInterval(function(){i&&(i=!1,n())},250),$("#main").fitVids(),$(".sticky").Stickyfill();var r=function(){(0===$(".author__urls-wrapper button").length?$(window).width()>1024:!$(".author__urls-wrapper button").is(":visible"))?(Stickyfill.rebuild(),Stickyfill.init(),$(".author__urls").show()):(Stickyfill.stop(),$(".author__urls").hide())};r(),$(window).resize(function(){r()}),$(".author__urls-wrapper button").on("click",function(){$(".author__urls").fadeToggle("fast",function(){}),$(".author__urls-wrapper button").toggleClass("open")}),$("a").not(".masthead__link--resume-access").smoothScroll({offset:-20});var o=$("#resume-access-dialog"),a=null;$(document).on("click",".masthead__link--resume-access",function(t){t.preventDefault(),a=this,e()}),$(document).on("click","[data-resume-modal-dismiss]",function(){t()}),$(document).on("keydown",function(e){27!==e.keyCode||o.is("[hidden]")||t()}),$("a[href$='.jpg'],a[href$='.jpeg'],a[href$='.JPG'],a[href$='.png'],a[href$='.gif']").addClass("image-popup"),$(".image-popup").magnificPopup({type:"image",tLoading:"Loading image #%curr%...",gallery:{enabled:!0,navigateByImgClick:!0,preload:[0,1]},image:{tError:'<a href="%url%">Image #%curr%</a> could not be loaded.'},removalDelay:500,mainClass:"mfp-zoom-in",callbacks:{beforeOpen:function(){this.st.image.markup=this.st.image.markup.replace("mfp-figure","mfp-figure mfp-with-anim")}},closeOnContentClick:!0,midClick:!0})});